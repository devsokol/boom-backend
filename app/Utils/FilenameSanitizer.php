...
class FilenameSanitizer
{
    ...
    {
        $sanitizer = new self($filename);

        $sanitizer->stripPhp()->stripRiskyCharacters()->stripIllegalFilesystemCharacters();
    ...
    {
        $this->setFilename(filter_var($this->getFilename(), FILTER_UNSAFE_RAW));
    ...
    public function stripRiskyCharacters()
    {
        ...
        $this->setFilename(
            filter_var($this->getFilename(), FILTER_UNSAFE_RAW, $options)
        );
